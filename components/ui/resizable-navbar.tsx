  ...
  return (
    <motion.div
      ...
      className={cn(
        ...
        visible && "bg-white/80 dark:bg-neutral-950",
        className,
      )}
    >
      {children}
    ...
    >
      {items.map((item, idx) => (
        <Link
          ...
          className="relative px-4 py-2 lg:py-2 text-black dark:text-white lg:text-neutral-100 lg:dark:text-neutral-100 hover:bg-gray-100 dark:hover:bg-gray-800 dark:lg:hover:bg-transparent rounded-md lg:rounded-full w-full lg:w-auto"
        >
          {hovered === idx && (
            <motion.div
              layoutId="hovered"
  ...
  return (
    <motion.div
      animate={{
        ...
        y: visible ? 10 : 60,
        background: visible ? "transparent/20" : "transparent/20",
      }}
      transition={{
        type: "spring",
        stiffness: 200,
      ...
      className={cn(
        ...
        visible && "bg-white/80 dark:bg-transparent/20",
        className,
      )}
    >
      {children}
    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          exit={{ opacity: 0 }}
          className={cn(
            "absolute inset-x-0 top-16 z-50 flex w-full flex-col items-start justify-start gap-4 rounded-lg bg-white px-4 py-2 shadow-[0_0_24px_rgba(34,_42,_53,_0.06),_0_1px_1px_rgba(0,_0,_0,_0.05),_0_0_0_1px_rgba(34,_42,_53,_0.04),_0_0_4px_rgba(34,_42,_53,_0.08),_0_16px_68px_rgba(47,_48,_55,_0.05),_0_1px_0_rgba(255,_255,_255,_0.1)_inset] dark:bg-transparent/50 backdrop-blur-lg",
            className,
          )}
        >
          {children}
